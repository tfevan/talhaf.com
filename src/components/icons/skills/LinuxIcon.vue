<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="1.05em" height="1.2em" viewBox="0 0 256 295">
    <defs>
      <linearGradient id="SVGPY0tCbOa" x1="48.548%" x2="51.047%" y1="115.276%" y2="41.364%">
        <stop offset="0%" stop-color="#ffeed7" />
        <stop offset="100%" stop-color="#bdbfc2" />
      </linearGradient>
      <linearGradient id="SVGZrQemdEu" x1="54.407%" x2="46.175%" y1="2.404%" y2="90.542%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.8" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGViD9UWNq" x1="51.86%" x2="47.947%" y1="88.248%" y2="9.748%">
        <stop offset="0%" stop-color="#ffeed7" />
        <stop offset="100%" stop-color="#bdbfc2" />
      </linearGradient>
      <linearGradient id="SVGpwAGebry" x1="49.925%" x2="49.924%" y1="85.49%" y2="13.811%">
        <stop offset="0%" stop-color="#ffeed7" />
        <stop offset="100%" stop-color="#bdbfc2" />
      </linearGradient>
      <linearGradient id="SVGeLJpbd6T" x1="53.901%" x2="45.956%" y1="3.102%" y2="93.895%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGoqBSHerK" x1="45.593%" x2="54.811%" y1="5.475%" y2="93.524%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVG4QSySb4K" x1="49.984%" x2="49.984%" y1="89.845%" y2="40.632%">
        <stop offset="0%" stop-color="#ffeed7" />
        <stop offset="100%" stop-color="#bdbfc2" />
      </linearGradient>
      <linearGradient id="SVGmqOHmezj" x1="53.505%" x2="42.746%" y1="99.975%" y2="23.545%">
        <stop offset="0%" stop-color="#ffeed7" />
        <stop offset="100%" stop-color="#bdbfc2" />
      </linearGradient>
      <linearGradient id="SVG6COJqcYh" x1="49.841%" x2="50.241%" y1="13.229%" y2="94.673%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.8" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGMM2cICtb" x1="49.927%" x2="50.727%" y1="37.327%" y2="92.782%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGGYYiOcHn" x1="49.876%" x2="49.876%" y1="2.299%" y2="81.204%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGWdyw0crI" x1="49.833%" x2="49.824%" y1="2.272%" y2="71.799%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVG83oHF3vg" x1="53.467%" x2="38.949%" y1="48.921%" y2="98.1%">
        <stop offset="0%" stop-color="#ffa63f" />
        <stop offset="100%" stop-color="#ff0" />
      </linearGradient>
      <linearGradient id="SVGLpQcUdBQ" x1="52.373%" x2="47.579%" y1="143.009%" y2="-64.622%">
        <stop offset="0%" stop-color="#ffeed7" />
        <stop offset="100%" stop-color="#bdbfc2" />
      </linearGradient>
      <linearGradient id="SVGehok0c3p" x1="30.581%" x2="65.887%" y1="34.024%" y2="89.175%">
        <stop offset="0%" stop-color="#ffa63f" />
        <stop offset="100%" stop-color="#ff0" />
      </linearGradient>
      <linearGradient id="SVGSLPsocSe" x1="59.572%" x2="48.361%" y1="-17.216%" y2="66.118%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGr4fuKdTl" x1="47.769%" x2="51.373%" y1="1.565%" y2="104.313%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGOxCzIbUA" x1="43.55%" x2="57.114%" y1="4.533%" y2="92.827%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <linearGradient id="SVGp3HnSbuR" x1="49.733%" x2="50.558%" y1="17.609%" y2="99.385%">
        <stop offset="0%" stop-color="#ffa63f" />
        <stop offset="100%" stop-color="#ff0" />
      </linearGradient>
      <linearGradient id="SVGSUrnubkU" x1="50.17%" x2="49.68%" y1="2.89%" y2="94.17%">
        <stop offset="0%" stop-color="#fff" stop-opacity="0.65" />
        <stop offset="100%" stop-color="#fff" stop-opacity="0" />
      </linearGradient>
      <filter
