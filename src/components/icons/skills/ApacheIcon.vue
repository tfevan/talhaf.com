<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 128 128">
    <path
      fill="url(#SVGiMAGwbYW)"
      d="M86.522.606c-2.007 1.185-5.348 4.54-9.318 9.407l3.652 6.903c2.57-3.666 5.177-6.977 7.807-9.8l.304-.325l-.304.326c-.852.933-3.437 3.955-7.333 9.94c3.755-.185 9.518-.956 14.222-1.756c1.407-7.844-1.37-11.429-1.37-11.429S90.654-1.83 86.521.606Z"
    />
    <use href="#SVGqpRHramL" />
    <use href="#SVGqpRHramL" opacity="0.35" />
    <use href="#SVGjx6Wbd1S" />
    <use href="#SVGjx6Wbd1S" opacity="0.35" />
    <path
      fill="url(#SVGtzsyJdUB)"
    ...
    />
    <use href="#SVG9M07Cb1Y" />
    <use href="#SVG9M07Cb1Y" opacity="0.35" />
    <path
      fill="url(#SVGpkL1XcTS)"
      d="M73.516 58.729q-.366.066-.741.111c.252-.022.503-.067.74-.111Z"
    />
    <use href="#SVGR2xhLdCv" />
    <use href="#SVGR2xhLdCv" opacity="0.35" />
    <path
      fill="url(#SVGjZOcddHG)"
      d="M75.449 52.566c.074-.007.155-.022.23-.037c-.075.008-.149.03-.23.037"
    />
    <use href="#SVGh4ytmcJV" />
    <use href="#SVGh4ytmcJV" opacity="0.35" />
    <path fill="url(#SVGbHauu8wp)" d="M75.449 52.566c.007 0 .007-.007 0 0c.007-.007.007 0 0 0" />
    <defs>
      <linearGradient
        id="SVGiMAGwbYW"
        x1="80.277"
      ...
      <path
        id="SVGqpRHramL"
        fill="#bd202e"
        d="M74.234 58.596c-.467.081-.94.17-1.437.252c0 0-.007 0-.007.007l.74-.111c.23-.052.467-.096.704-.148"
      />
      <path
        id="SVGjx6Wbd1S"
        fill="#bd202e"
        d="M75.456 52.559s0 .007 0 0q-.009-.002-.007.007c.074-.007.155-.022.23-.037c.31-.044.614-.096.91-.17c-.37.067-.74.133-1.133.2"
      />
      <path
        id="SVG9M07Cb1Y"
        fill="#bd202e"
      ...
      <path
        id="SVGh4ytmcJV"
        fill="#bd202e"
        d="M75.449 52.566c.007 0 .007-.007 0 0c.007-.007.007 0 0 0"
      />
    </defs>
  </svg>
</template>
